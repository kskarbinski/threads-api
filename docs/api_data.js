define({ "api": [
  ...
  },
  {
    ...
    "groupTitle": "User",
    "name": "GetUsersIdStringUser_id"
  },
  {
    "type": "GET",
    "url": "/users/name/<String:username>",
    ...
    "groupTitle": "User",
    "name": "GetUsersNameStringUsername"
  },
  {
    "type": "GET",
    ...
    "parameter": {
      "fields": {
        "URL query param": [
          {
            "group": "URL query param",
            "type": "String",
            "optional": false,
            "field": "username",
            "description": "<p>Validate username. Has to be unique, must not be a number, length 2-20</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "",
    "url": "ThreadApplicationModel",
    "title": "ThreadApplicationModel",
    "group": "_Models",
    "success": {
      "examples": [
        {
    ...
    "version": "0.0.0",
    "filename": "app_models/thread_application_model.py",
    "groupTitle": "_Models",
    "name": "Threadapplicationmodel"
  },
  {
    "type": "",
    "url": "ThreadInvitationModel",
    "title": "ThreadInvitationModel",
    "group": "_Models",
    "success": {
      "examples": [
        {
    ...
    "version": "0.0.0",
    "filename": "app_models/thread_invitation_model.py",
    "groupTitle": "_Models",
    "name": "Threadinvitationmodel"
  },
  {
    "type": "",
    "url": "ThreadMessageModel",
    "title": "ThreadMessageModel",
    "group": "_Models",
    "success": {
      "examples": [
        {
    ...
    "version": "0.0.0",
    "filename": "app_models/thread_message_model.py",
    "groupTitle": "_Models",
  ...
  },
  {
    ...
    "version": "0.0.0",
    "filename": "app_models/thread_model.py",
    "groupTitle": "_Models",
    "name": "Threadmodel"
  },
  {
    ...
    "version": "0.0.0",
    "filename": "app_models/user_model.py",
    "groupTitle": "_Models",
    "name": "Usermodel"
  },
  {
    "type": "",
    "url": "UsernameValidationModel",
    "title": "UsernameValidationModel",
    "group": "_Models",
    "success": {
      "examples": [
        {
    ...
    "version": "0.0.0",
    "filename": "app_models/username_validation_model.py",
    "groupTitle": "_Models",
    "name": "Usernamevalidationmodel"
  },
  {
    "type": "",
    "url": "ApplicationStatusType",
    ...
    "version": "0.0.0",
    "filename": "app_types/application/status/application_status_type.py",
    "groupTitle": "_Types",
    "name": "Applicationstatustype"
  },
  {
    "type": "",
    "url": "InvitationStatusType",
    "title": "InvitationStatusType",
    "group": "_Types",
    "success": {
      "examples": [
        {
    ...
    "version": "0.0.0",
    "filename": "app_types/invitation/status/invitation_status_type.py",
    "groupTitle": "_Types",
